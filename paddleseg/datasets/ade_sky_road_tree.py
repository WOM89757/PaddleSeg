...
class ADE20KSkyRoadTree(Dataset):
    """
    ADE20KSkyRoadTree dataset `http://sceneparsing.csail.mit.edu/`.
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'val':
            ...
            tree = label == 4
            road = label == 6
            all_area = (sky + tree + road)
            invert_area = [all_area == 0]
            label[invert_area] = 255
            label[label == 2] = 0
            label[label == 4] = 1
            label[label == 6] = 2
